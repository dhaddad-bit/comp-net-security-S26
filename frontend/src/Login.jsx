  ...
  return (
      <div className="login-container">
        ...
        <main className="login-main">
          <section id="auth" className="auth-bar">
            {errorMsg && <p className="auth-error" role="alert">{errorMsg}</p>}
            <button id="loginBtn" onClick={handleLogin}>Continue with Google</button>
            <p className="auth-sub">Share availability with friends and schedule meetings in minutes.</p>
          </section>
          ...
          <div className="columns">
            <div className='column'>
              ...
              <p>
                ...
                start making scheduling easier. Just press Continue with Google
        ...
        <footer id="legal-footer" className="legal-footer">
          <div className="legal-footer-inner">
            <span className="legal-copy">© {new Date().getFullYear()} Social Scheduler</span>
            <nav className="legal-links" aria-label="Site policies">
              <a href="/privacy">Privacy Policy</a>
              <span className="legal-sep" aria-hidden="true">·</span>
              <a href="/tos">Terms of Service</a>
              <span className="legal-sep" aria-hidden="true">·</span>
              <a href="mailto:33david.haddad@gmail.com">Contact</a>
            </nav>
          </div>
        </footer>
      </div>
